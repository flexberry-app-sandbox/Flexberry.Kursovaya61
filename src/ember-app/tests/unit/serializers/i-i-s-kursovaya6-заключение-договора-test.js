...
moduleForModel('i-i-s-kursovaya6-заключение-договора', 'Unit | Serializer | i-i-s-kursovaya6-заключение-договора', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya6-заключение-договора',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
