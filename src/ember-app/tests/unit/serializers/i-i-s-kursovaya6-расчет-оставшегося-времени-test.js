...
moduleForModel('i-i-s-kursovaya6-расчет-оставшегося-времени', 'Unit | Serializer | i-i-s-kursovaya6-расчет-оставшегося-времени', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya6-расчет-оставшегося-времени',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
