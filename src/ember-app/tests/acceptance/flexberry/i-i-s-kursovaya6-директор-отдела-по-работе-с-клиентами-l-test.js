...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya6 директор отдела по работе с клиентами l');

test('testing i-i-s-kursovaya6-директор-отдела-по-работе-с-клиентами-l', function(assert) {
